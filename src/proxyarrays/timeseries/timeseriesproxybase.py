...
from ..timeaxis import TimeAxisProxyBase


# Definitions #
# Classes #
class TimeSeriesProxyBase(TimeProxyBase):
    """An interface which outlines the basis for a time series proxy."""
...
class FoundTimeDataRange(NamedTuple):
    ...
    data: TimeSeriesProxyBase | None
    axis: TimeAxisProxyBase | None
